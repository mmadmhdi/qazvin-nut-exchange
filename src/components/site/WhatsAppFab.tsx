...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[4.75rem] end-3 z-50 inline-flex h-12 w-12 items-center justify-center gap-2 rounded-full border border-brass/40 bg-olive-deep text-xs tracking-widest text-paper shadow-lg transition-transform hover:-translate-y-0.5 hover:bg-olive lg:bottom-5 lg:h-auto lg:w-auto lg:px-4 lg:py-3"
    >
      ...
      <span className="hidden lg:inline">واتساپ</span>
    </a>
  );
}
